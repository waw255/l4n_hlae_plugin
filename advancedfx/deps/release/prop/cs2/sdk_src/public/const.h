...
//
//=============================================================================//
#ifndef SOURCESDK_CS2_CONST_H
#define SOURCESDK_CS2_CONST_H
...
#define	SOURCESDK_CS2_MAX_EDICT_BITS				14			// # of bits needed to represent max edicts
// Max # of edicts in a level
#define	SOURCESDK_CS2_MAX_EDICTS					(1<<SOURCESDK_CS2_MAX_EDICT_BITS)
...
#define SOURCESDK_CS2_NUM_ENT_ENTRY_BITS		(SOURCESDK_CS2_MAX_EDICT_BITS + 2)
#define SOURCESDK_CS2_NUM_ENT_ENTRIES			(1 << SOURCESDK_CS2_NUM_ENT_ENTRY_BITS)
#define SOURCESDK_CS2_INVALID_EHANDLE_INDEX	0xFFFFFFFF
