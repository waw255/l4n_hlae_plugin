...
#ifdef AFX_L4N_PLUGIN
bool g_L4nHlaeInitialized = false;
#endif
...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpReserved)
{
	...
	{ 
		...
		{
#ifdef AFX_L4N_PLUGIN
			L4nPluginLogEvent("DllMain attach");
#endif
			...
			{
				L4nPluginLogEvent("HLAE disabled: missing -l4n_hlae");
				break;
			}
#else
